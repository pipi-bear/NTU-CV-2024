   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "amplitude 10 =  13.279032782904412\n",
      "amplitude 30 =  -5.863700567522756\n",
      "salt and pepper 0.1 =  -1.5450143663807747\n",
      "salt and pepper 0.05 =  6.486651891089071\n",
      "--------------------------------\n",
      "closing-then-opening\n",
      "amplitude 10 =  13.203517744226176\n",
      "amplitude 30 =  -4.206302520618325\n",
      "salt and pepper 0.1 =  -2.546296411553107\n",
      "salt and pepper 0.05 =  5.447182550355941\n"
     ]
    }
   ],
   "source": [
